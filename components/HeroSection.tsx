            ...
            <div className="relative h-full flex">
              <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-10  w-full">
                ...
                <div className="hidden relative sm:flex justify-end">
                  <div
                    className="absolute top-12 right-20 rounded-full w-32 h-32 md:w-40 md:h-40 flex flex-col items-center justify-center shadow-2xl text-4xl font-bold z-20"
                    style={{
                      backgroundImage:
