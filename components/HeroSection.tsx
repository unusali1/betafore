...
export default function HeroCarousel() {
  ...
  return (
    <section className="relative sm:h-96 h-[50vh] w-full bg-[#F3EDC9] ">
            ...
            <div className="relative h-full flex">
              <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-10  w-full">
                ...
                <div className="relative flex justify-end">
                  <div
                    className="hidden absolute top-8 lg:top-12 right-4 md:right-0 lg:right-12 2xl:-right-4 rounded-full w-32 h-32 md:w-40 md:h-40 sm:flex flex-col items-center justify-center shadow-2xl text-4xl font-bold z-20"
                    style={{
                      backgroundImage:
      ...
      <div className="absolute bottom-1 sm:bottom-10 2xl:bottom-2 left-1/2 -translate-x-1/2 z-30 flex gap-3">
        {slides.map((_, index) => (
          <button
            key={index}
